---
name: pr-review-sop
description: Mandatory security + quality SOP for reviewing pull requests against a example repo. Use whenever the user asks to review, audit, or merge a PR.
---
