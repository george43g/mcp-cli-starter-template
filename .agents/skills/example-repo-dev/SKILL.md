...
description: Cloud-agent environment setup for working on this repo — Node 24 activation, corepack/pnpm, frozen-lockfile install — before any dev task in a cloud workspace. The canonical tool-usage skill is .agents/skills/example-repo/SKILL.md.
---

# example-repo-dev (cloud-agent skill)

> This file is a thin pointer for cloud agents. The canonical skill lives at `.agents/skills/example-repo/SKILL.md`.
